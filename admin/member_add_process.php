...
$stmt = $conn->prepare("
    INSERT INTO members
    (name, mobile, whatsapp_number, haal_niwas, mool_niwas, vyavsaya, pin, nivasi, gotra, membership_type, status, is_verified, is_canvote)
    VALUES (?,?,?,?,?,?,?,?,?,?,'approved',?,?)
");
...
// ✅ CORRECT bind_param (10 strings + 2 ints = 12 total)
$stmt->bind_param(
    "ssssssssssii",
    $name,
    $mobile,
